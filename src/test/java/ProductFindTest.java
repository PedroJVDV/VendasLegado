...
public class ProductFindTest {
    ...
    void findAllProductsTest() throws SQLException {
        ...
        List<Product> productTest = List.of(new Product("Cama", new BigDecimal("1249.99"), 25, true, "teste", Category.TESTE));
    ...
    void findByIdTest() throws SQLException {
        ...
        Product productTest = new Product("botas de chuva", new BigDecimal("50.00"), 21, true, "teste", Category.TESTE);
    ...
    void findByCategory() throws SQLException {
        ...
        List<Product> productTest = List.of(
                new Product("celta 1.0 1999", new BigDecimal("22399.99"), 1, true, "teste", Category.TESTE),
                new Product("Corsa 1.4 2007", new BigDecimal("32450.00"), 1, true, "teste", (Category.TESTE)));

        when(productDao.findProductByCategory(Category.TESTE)).thenReturn(productTest);
        ...
        assertEquals("teste", resultList.get(0).getDescription());
    }
    ...
    void findWithDiscount() throws SQLException {
        ...
        List<Product> productTest = List.of(
                new Product("camiseta seleção brasileira masculina - 2026", new BigDecimal("500.00"), 10, true, "teste", Category.TESTE),
                new Product("camiseta seleção brasileira feminina - 2026", new BigDecimal("500.00"), 10, true, "teste", Category.TESTE));
    ...
    void findByDate() throws SQLException {
        ...
        List<Product> productTest = List.of(new Product("iphone 17 pro max", new BigDecimal("7600"), 5, true, "teste", Category.TESTE));
    ...
    void findSoldout() throws SQLException {
        ...
        List<Product> productTest = List.of(new Product("televisao samsung oled 64' ", new BigDecimal("4299.99"), 0, false, "teste", Category.TESTE));
