...
public class DiscountDao {
    ...
    public Discount updateEndDate()throws SQLException{
    ...
    public Discount softDeleteDiscount()throws SQLException{
    ...
    public Discount deactivateExpiredDiscount() throws SQLException {
    ...
    public List<Discount> findActiveDiscountById()throws SQLException{
        List<Discount> activeDiscounts = new ArrayList<>();
