...
# PROJETO DE VENDAS LEGADO | SIMULADO EM CONSOLE!

Este é um projeto desenvolvido em **Java, JDBC, MySQL e Padrão de Projeto DAO.**

- O principal objetivo desse projeto é replicar algumas funcionalidades que são consolidadas no mercado, como: **Login de Clientes, Armazenamento de Dados (Produtos e Clientes), Carrinho de produtos, Descontos, Promoções e Validação de Dados!**
